...
import { ImgMain, ImgRecycled, Container, Container2, Container3, CompaniesInfo, Button, BemVindo, TxtConsumo, H2Styled, DivImgs } from './styles';
  ...
  return (
    <>
      ...
      <Container3>
        ...
        <p>A Studio eco visa o desenvolvimento de modelos palpáveis de sustentabilidade para roupas femininas dentro do mercado de moda brasileira.</p>
        </CompaniesInfo>
        ...
        <p>A Pano Social é uma marca que utiliza peças usadas e faz o restauro e styling, dando uma vida completamente nova às peças. Com um tom jovem e energético, o projeto utiliza conceitos da moda circular para revolucionar o fashion na periferia.</p>
        </CompaniesInfo>
